...
import io.realworld.angular.conduit.exceptionshandler.exception.SimpleException;
...
public class UserServiceImpl implements UserService, UserDetailsService {
    ...
    public ResponseEntity<UserResponse> loginUser(UserResponse userResponse) {
        ...
        User user = userRepository.findByEmail(userDTO.email()).orElseThrow(() -> new io.realworld.angular.conduit.exception.UsernameOrPasswordInvalid("Username or password invalid"));
        ...
        if (passwordEncoder.matches(userDTO.password(), user.getPassword())) {
            ...
            throw new io.realworld.angular.conduit.exception.UsernameOrPasswordInvalid("Username or password invalid");
        }
    }
